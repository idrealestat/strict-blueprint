...
const SlugCityPage: React.FC = () => {
  ...
  // حماية من تداخل المسارات: /:slug/appointmentapproval/sorry قد يُلتقط أحياناً كمدينة
  if (slug && citySlug === 'appointmentapproval') {
    return <Navigate to={`/${slug}/appointmentapproval/sorry`} replace />;
  }
