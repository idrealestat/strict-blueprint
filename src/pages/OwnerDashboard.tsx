...
const OwnerDashboard: React.FC = () => {
  ...
  const FEATURE_LOCATIONS: Record<string, { enable: string; disable: string }> = {
    ...
    business_card_add_colleague_enabled: {
      enable: 'سيظهر زر إضافة زميل في بطاقة الاسم',
      disable: 'سيختفي زر إضافة زميل من بطاقة الاسم',
    },
    crm_calls_section_enabled: {
      enable: 'سيظهر قسم الاتصالات في إدارة العملاء',
      disable: 'سيختفي قسم الاتصالات من إدارة العملاء',
    },
  };
