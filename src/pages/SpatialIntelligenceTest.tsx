...
import { ArrowRight, MapPin, Sparkles, Play, RefreshCw, Eye, Users, Flame } from 'lucide-react';
...
import VisitorsHeatMap from '@/components/analytics/VisitorsHeatMap';
import ViewsLogPage from '@/components/analytics/ViewsLogPage';
...
export default function SpatialIntelligenceTest({ onBack }: SpatialIntelligenceTestProps) {
  ...
  const [activeTab, setActiveTab] = useState<'analysis' | 'visitors' | 'logs'>('analysis');
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef]" dir="rtl">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl font-bold">الذكاء المكاني</h1>
                <p className="text-sm text-white/80">وساطه AI - تحليل المواقع وخريطة الزوار</p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto p-4 py-8">
        <Tabs value={activeTab} onValueChange={(v: any) => setActiveTab(v)} className="w-full">
          <TabsList className="w-full grid grid-cols-3 mb-6 bg-white border-2 border-[#D4AF37]/30">
            <TabsTrigger 
              value="analysis" 
              className="data-[state=active]:bg-[#01411C] data-[state=active]:text-white gap-2"
            >
