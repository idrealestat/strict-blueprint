...
import heroBroker from "@/assets/landing-broker-saudi.jpg";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="relative min-h-[85vh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[85vh] max-w-7xl flex-col justify-center gap-6 px-6 py-16 lg:px-10">
