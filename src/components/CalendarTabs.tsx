                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <Button
                      ...
                      onClick={() => copyToClipboard(`https://wasataai.com/${slug}/appointmentapproval/customer/{appointmentId}`, 'customer')}
                    >
                      {copiedLink === 'customer' ? (
                  ...
                  <div className="flex items-center justify-between p-2 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      className="h-7 text-xs gap-1"
                      onClick={() => copyToClipboard(`https://wasataai.com/${slug}/appointmentapproval/sorry`, 'sorry')}
                    >
                      {copiedLink === 'sorry' ? (
                        <><CheckCircle2 className="w-3 h-3 text-green-500" /> تم</>
                      ) : (
