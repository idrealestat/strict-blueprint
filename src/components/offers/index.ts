// ملف: src/components/offers/index.ts
// تصدير مكونات العروض

export { ShareOfferModal } from './ShareOfferModal';
...
export { default as QuickSellOfferCard } from './QuickSellOfferCard';
export { default as OffersStatsCards } from './OffersStatsCards';
export { default as OffersViewsChart } from './OffersViewsChart';
export { default as ViewNotificationSettings } from './ViewNotificationSettings';
