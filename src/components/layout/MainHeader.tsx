      ...
      <div className="container mx-auto px-2 sm:px-4 py-2">
        <div className="flex items-center justify-between gap-1 sm:gap-2">
          ...
          <div className="flex-1 min-w-0 flex items-center justify-center gap-2 sm:gap-3">
            <div className="inline-flex items-center gap-1 sm:gap-2 bg-white/10 text-white px-2 sm:px-4 py-1 sm:py-1.5 rounded-full shadow-lg border-2 border-wasata-gold backdrop-blur-sm">
              <Building2 className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
              <span className="font-bold text-xs sm:text-base">وساطه</span>
              <span className="font-bold text-wasata-gold text-xs sm:text-base">AI</span>
              <span className="font-bold text-xs sm:text-base hidden sm:inline">Wasata</span>
            </div>
            
            {/* مؤشر مباشر النابض */}
            {isPublished && (
              <div className="hidden xs:inline-flex sm:inline-flex items-center gap-1.5 bg-green-400/20 text-green-300 px-2 sm:px-3 py-1 rounded-full border border-green-400/40 animate-pulse">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <div className="relative">
              <Button
                ...
                className="border-2 border-wasata-gold hover:bg-white/20 bg-white/10 text-white relative h-8 w-8 sm:h-9 sm:w-9"
              >
